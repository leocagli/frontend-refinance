...
const mockCampaigns: CampaignWithRelations[] = [
  {
    ...
    description:
      'Una campaña para sostener viandas semanales, comprar insumos y financiar la ampliacion del comedor barrial.',
    goal_amount: 1200000,
    min_donation: 10000,
    ...
    milestones: [
      ...
      },
      {
        ...
        description: 'Apertura de una segunda línea de cocina comunitaria.',
        status: 'pending',
        proof_description: null,
        proof_url: null,
        validated_at: null,
    ...
    content_assets: [
      {
        ...
        content:
          'Estoy ayudando a Comedor Esperanza. Con $10.000 ya cubrís un almuerzo completo. Sumate acá: /c/comedor-esperanza',
        version: 3,
      },
      {
        id: 'asset_002',
      ...
      },
      {
        ...
        content:
          'Buscamos aliados para ampliar una red de apoyo alimentario con trazabilidad de hitos y reporte público de impacto.',
        version: 1,
      },
      {
        id: 'asset_004',
        ...
        content:
          'Asunto: Comedor Esperanza necesita tu ayuda\n\nQueremos invitarte a financiar viandas, insumos y la expansión de la cocina comunitaria.',
        version: 1,
      },
    ],
    promoters: [
    ...
    summary:
      'La campaña combina WhatsApp, landing pública, kit viral y liberación por hitos verificables.',
  ...
  },
  {
    ...
    description:
      'Un fondo para herramientas, semillas y capacitación para ampliar una huerta que abastece a familias del barrio.',
    goal_amount: 900000,
    min_donation: 8000,
    ...
    impact_per_amount: {
      ...
      '25000': 'Herramientas básicas para una cuadrilla.',
    ...
    milestones: [
      ...
      },
      {
        ...
        description: 'Construcción de nuevos canteros y riego simple.',
        status: 'reached',
        proof_description: null,
        proof_url: null,
        validated_at: null,
      },
      {
        ...
        description: 'Talleres abiertos y distribución barrial de cosecha.',
        status: 'pending',
        proof_description: null,
        proof_url: null,
        validated_at: null,
    ...
    content_assets: [
      {
        ...
        content:
          'Con 8 mil pesos ya sumás semillas para una temporada. Huerta Viva comparte avances y evidencia pública en cada hito.',
        version: 2,
      },
      {
        id: 'asset_102',
        ...
        content:
          'Sembrar también es sostener a una comunidad. Huerta Viva ya lleva cosechas y ahora quiere expandirse.',
        version: 2,
      },
      {
        id: 'asset_103',
        ...
        content:
          'Buscamos apoyo para infraestructura simple, trazable y de impacto directo para un proyecto de alimentación local.',
        version: 1,
      },
      {
        id: 'asset_104',
    ...
    summary:
      'Proyecto de alimentación y autonomización comunitaria con seguimiento de hitos y evidencia.',
